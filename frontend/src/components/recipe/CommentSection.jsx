...
export default function CommentSection({ recipeId, isOwnRecipe, comments, setComments, myComment, setMyComment, commentScore, setCommentScore, setAvgRating, setRatingsCount }) {
